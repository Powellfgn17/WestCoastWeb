  ...
  services: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          "Continuous hosting",
          "Content updates (text, photos, hours)",
      ...
      },
      {
        ...
        features: [
          ...
          "1 local blog article per month",
          "5 keyword ranking tracking",
          "Simple monthly report",
          "Google My Business monthly update",
        ],
        cta: "Choose Growth",
      },
      {
...
const fr: typeof en = {
  ...
  services: {
    ...
    titleLine1: "Tarifs transparents.",
    titleLine2: "Pas de pièges.",
    description:
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          "Hébergement continu",
          "Mises à jour de contenu (texte, photos, horaires)",
          "Sécurité et sauvegardes automatiques",
          "Support prioritaire (réponse sous 48h)",
          "Résiliable à tout moment — préavis de 30 jours",
        ],
        cta: "Ajouter Care",
      },
      {
        ...
        features: [
          "Tout le plan Care",
          "Optimisation SEO locale mensuelle",
          "1 article de blog local par mois",
          "Suivi de position sur 5 mots-clés",
          "Rapport mensuel simple",
          "Mise à jour mensuelle Google My Business",
        ],
